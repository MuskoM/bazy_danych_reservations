...
urlpatterns += [
    ...
    path('admin/pending_room_reservations/', login_required(Pending_room_reservations.as_view()),
         name="pending_room_reservations"),
    ...
    path('user/all_room_reservations/res=<int:room_reservation_id>/detail', views.detailed_room_reservation,
         name="room_reservation_details"),
    path('user/all_room_reservations/res=<int:room_reservation_id>/resign', views.resign_from_room_reservation,
         name="resign_from_room_reservation"),
    # ////DONE
