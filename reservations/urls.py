...
urlpatterns += [
    ...
    path('user/all_reservations/res=<int:reservation_id>/detail', views.detailed_reservation,name="reservation_details"),
    # Zrezygnowanie bądź przełożenie rezerwacji
    path('user/all_reservations/res=<int:reservation_id>/resign', views.resign_from_reservation,name= "resign_from_reservation"),
